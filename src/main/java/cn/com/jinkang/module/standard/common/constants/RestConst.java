...
public interface RestConst {
    ...
    enum BizError implements RestEnum {
         ...
         * 强制登录标识.
         */
        FORCE_LOGIN_RESOURCES(20009, "forceLoginResources"),

        QUOTA_ERROR(20010, "validate quota failure"),
        /**
         * 未知错误.
         */
    ...
    enum BssError implements RestEnum {
        ACCOUNT_RESTRICTIONS(30001, "AccountRestrictions"),
        THIRD_PARTY_ERROR(30002, "ThirdPartyError");

        BssError(int code, String type) {
            this.code = code;
            this.type = type;
        }
        ...
        public static boolean contains(int code) {
            boolean flag = false;
            for (RestEnum bssError : BssError.values()) {
                if (bssError.getCode() == code) {
                    flag = true;
                }
            }
            return flag;
